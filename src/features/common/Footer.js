    ...
    <footer class="w-full text-gray-700 bg-gray-100 body-font">
        <div
            ...
            <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                <h1>Kharedi</h1>
                <p class="mt-2 text-sm text-gray-500">Just share Happiness with delivering Your Order</p>
                <div class="mt-4">
        ...
        <div class="bg-gray-300">
            <div class="container px-5 py-4 mx-auto">
                <p class="text-sm text-gray-700 capitalize xl:text-center">Delivery © 2023 All rights reserved </p>
            </div>
        </div>
    </footer>
    </>
