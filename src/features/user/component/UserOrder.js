...
export default function UserOrders() {
    ...
    return (
        <div>
            {orders.map((order) => (
                <div className="mx-auto mt-16 bg-white max-w-7xl px-4 sm:px-6 lg:px-8 rounded-md shadow-md">
                                        ...
                                        <div className="ml-4 flex flex-1 flex-col">
                                            ...
                                            <div className="flex flex-1 items-end justify-between text-sm">
                                                <div className="text-gray-500">
                                                    <label htmlFor="quantity" class="inline mr-3 text-sm font-medium leading-6 text-gray-900">Qty : {item.quantity}</label>
                                                </div>
                    ...
                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                        ...
                        <div className="flex justify-between gap-x-6 my-3 p-5 border-solid border-2 rounded-md border-gray-200 ">
                            <div className="flex min-w-0 gap-x-4">

                                <div className="min-w-0 flex-auto">
                                    <p className="text-sm font-semibold leading-6 text-gray-900">{order.selectedAddress.name}</p>
                                    <p className="text-sm font-semibold leading-6 text-gray-600">{order.selectedAddress.email}</p>
