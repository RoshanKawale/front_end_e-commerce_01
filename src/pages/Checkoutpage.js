...
import {
    delteItemFromCartAsync,
    fetchUpdateItemAsync,
    selectItems,
...
const Checkoutpage = () => {
    ...
    const handleQuantity = (e, item) => {
        dispatch(fetchUpdateItemAsync({ ...item, quantity: +e.target.value }))
    }

    const handleRemove = (e, id) => {
        dispatch(delteItemFromCartAsync(id))
    }
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                    <div className='lg:col-span-3'>
                        <form className='bg-white p-5 mt-12' noValidate onSubmit={handleSubmit((data)=>{ dispatch(updateUserAsync({...user,addresses:[...user.addresses,data]})); reset(); })}>
                                ...
                                <div className="border-b border-gray-900/10 pb-12">
                                    ...
                                    <ul role="list" className="divide-y divide-gray-100">
                                        {user.addresses.map((address , index) => (
                                            <li key={index} className="flex justify-between gap-x-6 my-3 p-5 border-solid border-2 border-gray-200">
                                                <div className="flex min-w-0 gap-x-4">
                                                    ...
                                                    <div className="min-w-0 flex-auto">
                                                        ...
                                                        <p className="text-sm font-semibold leading-6 text-gray-600">{address.email}</p>
                                                ...
                                                <div className="ml-4 flex flex-1 flex-col">
                                                    ...
                                                    <div className="flex flex-1 items-end justify-between text-sm">
                                                        <div className="text-gray-500">
                                                            <label htmlFor="quantity" class="inline mr-3 text-sm font-medium leading-6 text-gray-900">Qty</label>
